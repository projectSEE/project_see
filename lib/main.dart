...
class BlindAssistApp extends StatefulWidget {
  const BlindAssistApp({super.key});

  @override
  State<BlindAssistApp> createState() => _BlindAssistAppState();
}

class _BlindAssistAppState extends State<BlindAssistApp> {
